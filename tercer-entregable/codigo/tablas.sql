...
DROP TABLE PROGRAMASDEPORTIVOS;
DROP TABLE EVENTOS;
...
-- Tabla de INSTITUCIONES y su clasificación de herencia
...
CREATE TABLE PATROCINADORES (
    OID_Patr INTEGER PRIMARY KEY NOT NULL,
    cif CHAR(9) NOT NULL,
...
-- Tabla de EVENTOS, PROGRAMAS DEPORTIVOS y ACTIVIDADES
...
CREATE TABLE ACTIVIDADES (
    ...
    FOREIGN KEY (OID_Proj) REFERENCES EVENTOS,
    FOREIGN KEY (OID_Proj) REFERENCES PROGRAMASDEPORTIVOS
);
...
CREATE TABLE PATROCINIOS (
    ...
    OID_Patr INTEGER NOT NULL,
    cantidad NUMBER(*,2) NOT NULL,
    OID_Act INTEGER NOT NULL,
    FOREIGN KEY (OID_Patr) REFERENCES PATROCINADORES,
    FOREIGN KEY (OID_Act) REFERENCES ACTIVIDADES
);
...
CREATE TABLE RECIBOS (
    ...
    estado VARCHAR2(50) NOT NULL
        CONSTRAINT enum_estadoRecibo CHECK (estado IN ('pagada', 'pendiente', 'anulada')),
    FOREIGN KEY (OID_Act) REFERENCES ACTIVIDADES,
    FOREIGN KEY (OID_Fin) REFERENCES PATROCINIOS,
    FOREIGN KEY (OID_Part) REFERENCES PARTICIPANTES
);
...
CREATE TABLE PREGUNTAS (
    ...
    FOREIGN KEY (OID_Form) REFERENCES CUESTIONARIOS
);
...
DROP SEQUENCE SEC_Patr;
CREATE SEQUENCE SEC_Patr INCREMENT BY 1 START WITH 1;
...
CREATE OR REPLACE TRIGGER SECUENCIA_PATROCINADORES
BEFORE INSERT ON PATROCINADORES
FOR EACH ROW
BEGIN
    SELECT SEC_Patr.NEXTVAL INTO :NEW.OID_Patr FROM DUAL;
END;
/

CREATE OR REPLACE TRIGGER SECUENCIA_EVENTOS
...
CREATE OR REPLACE TRIGGER SECUENCIA_PROGRAMASDEPORTIVOS
BEFORE INSERT ON PROGRAMASDEPORTIVOS
FOR EACH ROW
BEGIN
    SELECT SEC_Proj.NEXTVAL INTO :NEW.OID_Proj FROM DUAL;
END;
